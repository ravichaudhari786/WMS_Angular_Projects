...
export class DispatchComponent implements OnInit {
  ...
  onDispatchCellKeyPress(e: any) {
    ...
    if (e.data.BalanceQuantity > e.data.DispatchQuantity) {
      ...
      this.dialog.alert("DispatchQuantity Must be less than or equal to BalanceQuantity.....!!!");
      this.onDispatchDetailGridRefresh();
    }
  }
  ...
  onSaveDispatch() {
    ...
    if (this.form.value.customer_id == null || this.form.value.customer_id == "") {
      ...
      this.dialog.alert("Please.... Select Deliver To..!!!");
      ...
      this.dialog.alert("Please .... Add Dispatch quantity In delivery order detail ");
      return;
    } else {
      console.log(TotalDispatchQty);
      //this.dialog.alert("Work Fine ...!!!");
      this.clickSave = true;
      this.DispatchDetail = [];
  ...
  DispatchDetailcolumnDefs: ColDef[] = [
    { headerName: 'DeliveryOrderNo', field: 'DeliveryOrderNo', hide: false, filter: 'agTextColumnFilter', floatingFilter: true, width: 150 },
