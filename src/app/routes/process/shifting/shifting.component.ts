...
export class ShiftingComponent implements OnInit {
  ...
  OnActionShifting(d: any) {
    if (String(d.actions) == 'Delete') {
      ...
      this.api.get('/Shifting/ShiftingReceipt?ShiftingID=' + d.rowData.ShiftingID).subscribe(
        data => {
          data;
          console.log("OnActionShifting=>", data)
  ...
  ShiftingListColumnDefs: ColDef[] = [
    {
      ...
      cellRendererParams: {
        onClick: this.OnActionShifting.bind(this),
        label: 'Click 1'
      }
    },
